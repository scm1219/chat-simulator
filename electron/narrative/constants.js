...
export const EMOTION_KEYWORDS = {
  ...
  '尴尬':   { words: ['那个...', '咳', '误会', '其实不是'], intensity: 0.5 },
  '感动':   { words: ['谢谢', '谢谢你', '太感动', '没想到', '你真好'], intensity: 0.7 },
  '悲伤':   { words: ['难过', '伤心', '不想说', '无所谓了'], intensity: 0.6 },
  ...
  '好奇':   { words: ['怎么回事', '真的吗', '为什么呀', '为什么呢', '好想知道'], intensity: 0.5 },
...
// 注："平静"事件不在此映射——由 EmotionManager.updateFromEvent 特殊处理（重置为平静，强度 0）
